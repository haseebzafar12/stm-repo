...
$statusApproved = $db_helper->SingleDataWhere('stm_statuses','statusName = "Approved"');
$statusDone = $db_helper->SingleDataWhere('stm_statuses','statusName = "5-Done"');

$query = "SELECT * FROM stm_taskassigned WHERE taskuserID = '$session_id' AND taskStatusID != '".$statusApproved['id']."' AND taskStatusID != '".$statusDone['id']."'";
...
$query .= 'ORDER BY taskCreationDate DESC ';
