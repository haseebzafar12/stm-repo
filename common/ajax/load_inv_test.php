...
$output ='<table class="table table-striped table-sm">';
        ...
        $output .= '<tr>';
          $output .= '<th id="headings" colspan="5"></th><th id="headings" colspan="4" style="border-left:#a6a6a6 solid 1px;
        ...
        foreach($dataWeek as $list){ 
          ...
          $output .= '</tr>';
          $output .= '<tr>';
          $output .= '<th id="headings2"></th><th id="headings2"></th><th id="headings2"></th><th id="headings2"></th><th id="headings2"></th><th id="uper_rows_listing" colspan="4">Listed At</th>';
        foreach($dataWeek as $list){ 
