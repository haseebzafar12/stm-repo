...
$query = "SELECT * FROM stm_tasks WHERE taskStatusID!='17' AND taskStatusID!='".$deleteStatus['id']."'";
  ...
  if($_POST['category'] !='' AND $_POST['from'] != '' AND $_POST['status'] != ''){

    if($_POST['status'] == 'open'){
      $query = "SELECT * FROM stm_tasks WHERE taskTypeID = '".$_POST['category']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID NOT IN ('".$reviewStatus['id']."','".$deleteStatus['id']."')"; 
    }else if($_POST['status'] == 'closed'){
      $query = "SELECT * FROM stm_tasks WHERE taskTypeID = '".$_POST['category']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID = '".$reviewStatus['id']."'";
    }
  
  }else if($_POST['category'] !='' AND $_POST['from'] == '' AND $_POST['status'] != ''){
    if($_POST['status'] == 'open'){
      ...
      $query = "SELECT * FROM stm_tasks WHERE taskTypeID = '".$_POST['category']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' ";  
  }else if($_POST['category'] !='' AND $_POST['from'] == '' AND $_POST['status'] == ''){
  ...
  if($_POST['created_by'] !='' AND $_POST['from'] != '' AND $_POST['status'] != ''){

    if($_POST['status'] == 'open'){
      $query = "SELECT * FROM stm_tasks WHERE taskAssignedBy = '".$_POST['created_by']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID NOT IN ('".$reviewStatus['id']."','".$deleteStatus['id']."')"; 
    }else if($_POST['status'] == 'closed'){
      $query = "SELECT * FROM stm_tasks WHERE taskAssignedBy = '".$_POST['created_by']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID = '".$reviewStatus['id']."'";
    }
  
  }else if($_POST['created_by'] !='' AND $_POST['from'] == '' AND $_POST['status'] != ''){
    if($_POST['status'] == 'open'){
   ...
   $query = "SELECT * FROM stm_tasks WHERE taskAssignedBy = '".$_POST['created_by']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' "; 
  }else if($_POST['created_by'] !='' AND $_POST['from'] == '' AND $_POST['status'] == ''){
  ...
  if($_POST['priority'] !='' AND $_POST['from'] != '' AND $_POST['status'] != ''){

      if($_POST['status'] == 'open'){
        $query = "SELECT * FROM stm_tasks WHERE taskPriorityID = '".$_POST['priority']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID NOT IN ('".$reviewStatus['id']."','".$deleteStatus['id']."')"; 
      }else if($_POST['status'] == 'closed'){
        $query = "SELECT * FROM stm_tasks WHERE taskPriorityID = '".$_POST['priority']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID = '".$reviewStatus['id']."'";
      }
  
  }else if($_POST['priority'] !='' AND $_POST['from'] == '' AND $_POST['status'] != ''){
    if($_POST['status'] == 'open'){
   ...
   $query = "SELECT * FROM stm_tasks WHERE taskPriorityID = '".$_POST['priority']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' "; 
  }else if($_POST['priority'] !='' AND $_POST['from'] == '' AND $_POST['status'] == ''){
  ...
  if($_POST['assignees'] !='' AND $_POST['from'] != '' AND $_POST['status'] != ''){

      if($_POST['status'] == 'open'){
        $query = "SELECT * FROM stm_taskassigned WHERE taskuserID = '".$_POST['assignees']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID NOT IN ('".$doneStatus['id']."','".$stApprov['id']."') AND isActive = '1'"; 
      }else if($_POST['status'] == 'closed'){
        $query = "SELECT * FROM stm_taskassigned WHERE taskuserID = '".$_POST['assignees']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID IN ('".$doneStatus['id']."','".$stApprov['id']."') AND isActive = '1'";
      }
  
  }else if($_POST['assignees'] !='' AND $_POST['from'] == '' AND $_POST['status'] != ''){
    if($_POST['status'] == 'open'){
   ...
   $query = "SELECT * FROM stm_taskassigned WHERE taskuserID = '".$_POST['assignees']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND isActive = '1'"; 
  }else if($_POST['assignees'] !='' AND $_POST['from'] == '' AND $_POST['status'] == ''){
  ...
  if($_POST['skype'] !='' AND $_POST['from'] != '' AND $_POST['status'] != ''){

      if($_POST['status'] == 'open'){
        $query = "SELECT * FROM stm_tasks WHERE taskSkypeGroup = '".$_POST['skype']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID NOT IN ('".$reviewStatus['id']."','".$deleteStatus['id']."')"; 
      }else if($_POST['status'] == 'closed'){
        $query = "SELECT * FROM stm_tasks WHERE taskSkypeGroup = '".$_POST['skype']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' AND taskStatusID = '".$reviewStatus['id']."'";
      }
  
  }else if($_POST['skype'] !='' AND $_POST['from'] == '' AND $_POST['status'] != ''){
    if($_POST['status'] == 'open'){
   ...
   $query = "SELECT * FROM stm_tasks WHERE taskSkypeGroup = '".$_POST['skype']."' AND taskCreationDate BETWEEN '" . $_POST['from'] . "' AND  '" . $_POST['to'] . "' "; 
  }else if($_POST['skype'] !='' AND $_POST['from'] == '' AND $_POST['status'] == ''){
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr id="task_row_'.$row['id'].'">
      ...
      <td>'.$task_assignee.'</td>
      <td>
          <a class="rounded bs-tooltip" data-placement="top" title="View" href="stmtaskdetail.php?id='.$row['id'].'&view" target="_blank">
