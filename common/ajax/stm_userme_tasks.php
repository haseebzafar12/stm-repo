...
$query = "SELECT * FROM stm_tasks WHERE taskAssignedBy = '$session_id' 
";

  if($_POST['query'] != '')
  {
    $query .= '
    WHERE taskName LIKE "%'.str_replace(' ', '%', $_POST['query']).'%" ';
  }
...
if($total_data > 0)
{
  foreach($result as $row)
  {
    ...
    <tr>
      ...
      <td>
          <a href="stmtaskdetail.php?id='.$row['id'].'&view">
          ...
          <a href="stmtaskedit.php?id='.$row['id'].'">
