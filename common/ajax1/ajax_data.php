...
if(isset($_POST['post_m']) && $_POST['post_m'] == "FinalupdateSupplier"){
  ...
  $supplierData = $objUser->update_suppliers($_POST['supplierID'],$_POST['supplierName'],$supplierType);
...
if(isset($_POST['post_m']) && $_POST['post_m'] == "updateSupplier"){
  ...
  $ary = array("supplierName" => $supplierData['supplierName'],"supplierTypeID"=>$supplierTypeData['id'],"supplierType" => $supplierTypeData['supplierType']);
