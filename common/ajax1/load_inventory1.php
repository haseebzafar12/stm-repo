    ...
    $output .= '<tr>';
        ...
        if($res){
          foreach($res as $data){
            ...
            $amzOsVal = "";
            if(!$amzosData){
              $amzOsVal = "<img src='images/cross.png' height='20' width='20'>";
            }else{
              if($data['AmzOsVal']){
            ...
            $AmzQcVal = "";
            if(!$amzqcData){
              $AmzQcVal = "<img src='images/cross.png' height='20' width='20'>";
            }else{
              if($data['AmzQcVal']){
            ...
            $EbayOsVal = "";
            if(!$ebyosData){
              $EbayOsVal = "<img src='images/cross.png' height='20' width='20'>";
            }else{
              if($data['EbayOsVal']){
            ...
            if($ebayAo){
              ...
              $EbayAoVal = '<img src="images/cross.png" height="20" width="20">';
            } 
            
              $output .= '<td align="right">'.$data['AmzOsQty'].'</td>';
              $output .= '<td align="right">'.$amzOsVal.'</td>';

              $output .= '<td align="right">'.$data['AmzQcQty'].'</td>';
              $output .= '<td align="right">'.$AmzQcVal.'</td>';

              $output .= '<td align="right">'.$data['EbayOsQty'].'</td>';
              $output .= '<td align="right">'.$EbayOsVal.'</td>';

              $output .= '<td align="right">'.$data['EbayAoQty'].'</td>';
